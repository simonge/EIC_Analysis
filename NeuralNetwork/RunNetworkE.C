...
void RunNetworkE( TString myMethodList = "" )
{
   //---------------------------------------------------------------
...
//    reader->AddVariable( "cell_vector[0].fCoordinates.fY", &yV     );
   ...
   TString prefix = "RealHitsDecor-NormE-4Layers-Bigger10-2STEP4";
   //TString tag    = "";
   TString tag    = "FrontWindow";
   //   TString prefix = "TMVARegression";
   TString ofile = "Reg_cell-"+prefix+tag+".root";
...
//   std::vector<RResultPtr*> hists;
   auto energy = df2.Histo2D({"energy","energy",200,0,18,200,0,18},     "ePred","eE");
   ...
   df2.Snapshot("predict",ofile,{"eE","ePred"},opts);
